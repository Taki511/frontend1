          ...
          <div class="space-y-8">
              ...
              <div class="space-y-6">
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-gray-600">support@stageio.com</p>
                    <p class="text-gray-600">partnerships@stageio.com</p>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-gray-600">+213 555 123 456</p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-8">
              ...
              <div class="flex items-center gap-4">
                <a href="#" class="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-green-100 transition-colors">
                  <svg class="w-6 h-6 text-gray-600 hover:text-green-600" fill="currentColor" viewBox="0 0 24 24">
